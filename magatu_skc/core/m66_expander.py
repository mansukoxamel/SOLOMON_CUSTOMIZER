...
def change_mapper(src: bytes, region: str = "US") -> bytearray:
    ...
    l_a2 = bytes([
        ...
        40, 4, 201, 48, 240, 34, 165, 124, 106, 144, 29, 177, 0, 201, 248, 240,
        ...
        173, 40, 4, 10, 10, 10, 10, 10, 24, 105, 79, 133, 0,
        173, 40, 4, 74, 74, 74, 24, 105, 248, 133, 1,
        160, 32, 177, 0, 153, 63, 7, 136, 208, 248, 96
    ])
