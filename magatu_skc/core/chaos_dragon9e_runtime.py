...
SETUP_META_RUNTIME = bytes.fromhex(
    ...
    "a0 00"         # LDY #$00: speed group 0; state setup later writes Y velocity
    "b9 d3 d9"      # LDA $D9D3,Y
    "60"            # RTS
)
...
INIT_STATUS_RUNTIME = bytes.fromhex(
    "68"            # PLA: discard behavior computed for custom type $9E
    "a9 c0"         # LDA #$C0: active status used by Chaos Dragon9E
    "85 04"         # STA $04
    "a0 05"         # LDY #$05
    "a9 00"         # LDA #$00: clear property Y velocity until state setup runs
    "91 00"         # STA ($00),Y
