...
_TRANSLATIONS = {
    ...
    "hack_dialog.gargoyle_variant.row.speed1": {"ja": "7A/7B:", "en": "7A/7B:"},
    "hack_dialog.gargoyle_variant.row.speed2": {"ja": "7E/7F:", "en": "7E/7F:"},
    "hack_dialog.gargoyle_variant.speed.label": {"ja": "速度", "en": "Speed"},
    "hack_dialog.gargoyle_variant.cooldown.label": {"ja": "クールダウン", "en": "Cooldown"},
    "hack_dialog.gargoyle_variant.hint": {
        "ja": "強化ガーゴイル(7A/7B/7E/7F)は原作と同じく1発だけ撃ちます。速度は4択。7E/7Fのクールダウンは0F固定です。",
