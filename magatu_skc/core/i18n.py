...
_TRANSLATIONS = {
    ...
    "hack_dialog.saramandor_variant.hint": {
        "ja": "強化サラマンダー $5E/$5F が発射する炎だけに適用します。通常サラマンダーとドラゴンには影響しません。",
        "en": "Applies only to the flame fired by Enhanced Saramandor $5E/$5F. Stock Saramandor and Dragon are unaffected.",
    },
