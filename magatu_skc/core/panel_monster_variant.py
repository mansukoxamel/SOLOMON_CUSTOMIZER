...
def _build_fire_dispatch() -> bytes:
    ...
    a.b(0xC9, 0x52); a.branch(0x90, "check3")
    a.b(0xC9, 0x58); a.branch(0xB0, "check3")
...
def _build_bullet_hook() -> bytes:
    ...
    a.b(0xA0, 0x07, 0xB1, 0x2C)       # marker: 1/3=plus, 2/4=minus.
    a.b(0xC9, 0x01); a.branch(0x90, "done")
    a.b(0xC9, 0x05); a.branch(0xB0, "done")
    a.b(0xAA)                         # X = marker.
    a.b(0x29, 0x02); a.branch(0xF0, "axis")
    a.b(0xA0, 0x01, 0xB1, 0x2C, 0x29, 0x01)
    a.branch(0xD0, "done")
    a.label("axis")
    a.b(0xA0, 0x01, 0xB1, 0x2C, 0x29, 0x02)
    a.branch(0xF0, "yaxis")
    a.b(0xA0, 0x0A)                   # Up/down bullets spread on X.
    a.branch(0xD0, "coord")
    a.label("yaxis")
    a.b(0xA0, 0x07)                   # Right/left bullets spread on Y.
    a.label("coord")
    a.b(0xB1, 0x2E)
    a.b(0xE0, 0x02); a.branch(0xF0, "minus")
    a.b(0xE0, 0x04); a.branch(0xF0, "minus")
    a.b(0x18, 0x69, 0x01, 0x91, 0x2E)
    a.label("done")
    a.b(0x68, 0x60)                   # PLA / RTS
    a.label("minus")
    a.b(0x18, 0x69, 0xFF, 0x91, 0x2E)
    a.jmp(CPU_BULLET_HOOK)
    blob = bytearray(a.finish())
    blob[-2:] = _word(CPU_BULLET_HOOK + a.labels["done"])
    return bytes(blob)
