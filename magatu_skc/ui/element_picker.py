...
ENEMY_ENHANCE_CYCLES = (
    ...
    # Panel Monster: normal -> 2-way -> 3-way -> A -> B -> C -> normal.
    (0x24, 0x52, 0x5a, 0x41, 0x49, 0x31),
    (0x25, 0x53, 0x5b, 0x43, 0x4b, 0x33),
    (0x26, 0x56, 0x66, 0x45, 0x4d, 0x35),
    (0x27, 0x57, 0x67, 0x47, 0x4f, 0x37),
)
